...
public class TestClass {
    ...
    void testGetName3() {
        ...
        assertTrue(p.getName().equals("Kevin"));
    }
    ...
    void testGetName4() {
        Player p = new Player();
        assertTrue(p.getName().equals("Computer #4"));
    }
    ...
    void testGetName() {
        Player p = new Player();
        assertTrue(p.getName().equalsIgnoreCase("Computer #1"));
    }
    ...
    @Test
    void testTakeCard2() throws Exception {
        Player p = new Player();
        Card[] cards = {new Card(4), new Card(6), new Card(8), null, null, null};
        p.moveToPile(cards, 3);
